...
- (void)viewDidLoad
{
    ...
    UIScreenEdgePanGestureRecognizer *ineractiveTransitionLeftRecognizer = [[UIScreenEdgePanGestureRecognizer alloc] initWithTarget:self action:@selector(interactiveTransitionLeftRecognizerAction:)];
    ineractiveTransitionLeftRecognizer.edges = UIRectEdgeLeft;
    [self.view addGestureRecognizer:ineractiveTransitionLeftRecognizer];
}
...
- (IBAction)interactiveTransitionLeftRecognizerAction:(UIScreenEdgePanGestureRecognizer *)sender{
    ...
    self.presentingViewController.transitioningDelegate = transitionDelegate;
