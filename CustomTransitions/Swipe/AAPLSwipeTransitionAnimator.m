...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    CGAffineTransform fromTransform = isPresenting ? fromView.transform : toView.transform;
    if (isPresenting) {
        ...
        fromTransform = CGAffineTransformScale(fromTransform, 0.95, 0.95);
    } else {
        fromView.frame = fromFrame;
        fromTransform = CGAffineTransformScale(fromTransform, 1 / 0.95, 1 / 0.95);
//        toView.frame = toFrame;
    ...
    //presentedView frame变换
    fromFrame = CGRectOffset(fromFrame, CGRectGetWidth(fromFrame) * offset.dx, CGRectGetHeight(fromFrame) * offset.dy);
